 ...
 * This file demonstrates how to integrate Web3modal with a web frontend
 */

// For React/Vue/Angular applications
export class Web3modalClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Web3modalClient(provider, contractAddress);
